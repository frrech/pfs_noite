...
export class ProdutoController {
    ...
    public adicionarProduto(req: any, res: any): void {
        try{
            ...
            this.produtoService.adicionarProduto({ id, nome, preco, quantidade, categoria } as Produto);
    ...
    public atualizarProduto(req: any, res: any): void {
        try {
            ...
            this.produtoService.atualizarProduto(id, new Produto(nome, preco, categoria));
